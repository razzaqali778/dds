...
const Editable = ({editFormData,handleEditFrormChange, handleCancelClick}) => {
  return (
    ...
    <>
        ...
        {/* preset */}
        <td  className='table-elements'  ><input className='eInput' onChange={handleEditFrormChange} value={editFormData.newPreset} name ='p'/></td>
        {/* Drawing */}
        ...
        {/* Target */}
        <td  className='table-desc' ><input  className='eInput' name='t' onChange={handleEditFrormChange} value={editFormData.newTarget}/></td>
        {/* LowerLimit */}
